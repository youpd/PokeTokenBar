...
public static class ModelPricing
{
    private static readonly IReadOnlyDictionary<string, Prices> Exact =
        new Dictionary<string, Prices>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["gpt-5.6"] = new(5, 30, 6.25, 0.5),
            ["gpt-5.6-sol"] = new(5, 30, 6.25, 0.5),
            ["gpt-5.6-terra"] = new(2.5, 15, 3.125, 0.25),
            ["gpt-5.6-luna"] = new(1, 6, 1.25, 0.1),
            ["gpt-5.5"] = new(5, 30, 0, 0.5),
            ["gpt-5.4"] = new(2.5, 15, 0, 0.25),
            ["gpt-5.3-codex"] = new(1.75, 14, 0, 0.175),
